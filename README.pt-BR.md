...
|---|---|
| [Airbnb Rio — ML Geoespacial](https://github.com/ivanfborges/eng_dados-analytics_engineering) | Avaliação com anfitriões separados, diagnóstico espacial e CLI de inferência congelada. MAE final 22,22% menor que o baseline por tipo; relatórios bilíngues, exemplos fictícios e testes automatizados. |
...
| [EvoSuite × LLM](https://github.com/ivanfborges/sbst-vs-llm) | Estudo de testes para uma classe Java, com prompts e evidências arquivadas: ambas as suítes cobriram 17/18 branches; o PIT matou 16/25 mutantes com EvoSuite e 22/25 após refinamento da suíte LLM. Limites e protocolo futuro documentados. |
...
O estudo Airbnb agora inclui avaliação completa de ML e inferência; os demais projetos de aprendizado preservam seu contexto original. O [índice de estudos](STUDIES.pt-BR.md) reúne esses trabalhos, a participação no Kaggle e os materiais de formação.
